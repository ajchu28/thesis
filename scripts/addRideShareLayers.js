// Provides functionality to add layers to base map

allLayers = [
  'twelvepm0.json', 'zeroam0.json', 'zeroam15.json', 'zeroam30.json', 'zeroam45.json',
  ...
  'twelvepm15.json', 'twelvepm30.json', 'twelvepm45.json',
